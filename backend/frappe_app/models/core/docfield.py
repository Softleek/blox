...
class DocField(BaseModel):
    ...
    search_index = models.BooleanField(default=False, null=True, blank=True)
    ...
    translatable = models.BooleanField(default=False, null=True, blank=True)
    ...
    set_only_once = models.BooleanField(default=False, null=True, blank=True)
    ...
    oldfieldname = models.CharField(max_length=255, null=True, blank=True)
    oldfieldtype = models.CharField(max_length=255, null=True, blank=True)
    ...
    max_height = models.CharField(max_length=255, null=True, blank=True)
    ...
    not_nullable = models.BooleanField(default=False, null=True, blank=True)
    show_on_timeline = models.BooleanField(default=False, null=True, blank=True)
    placeholder = models.CharField(max_length=255, null=True, blank=True)
    make_attachment_public = models.BooleanField(default=False, null=True, blank=True)
    sticky = models.BooleanField(default=False, null=True, blank=True)
