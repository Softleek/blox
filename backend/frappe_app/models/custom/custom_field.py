...
class CustomField(BaseModel):
    dt = models.ForeignKey("frappe_app.Doctype", related_name="CustomFieldDt", on_delete=models.CASCADE, null=True, blank=True)
    label = models.CharField(max_length=255, null=True, blank=True)
    label_help = models.TextField(null=True, blank=True)
    fieldname = models.CharField(max_length=255, null=True, blank=True)
    CHOICES_INSERT_AFTER = [
        ("", ""),
    ]
    insert_after = models.CharField(choices=CHOICES_INSERT_AFTER, max_length=255, null=True, blank=True)
    CHOICES_FIELDTYPE = [
    ...
    options_help = models.TextField(null=True, blank=True)
    ...
    module = models.ForeignKey("frappe_app.ModuleDef", related_name="CustomFieldModule", on_delete=models.CASCADE, null=True, blank=True)
