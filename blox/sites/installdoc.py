...
def installdoc(site, app, module, doc):
    ...
    for folder in structure:
        ...
        if os.path.exists(doc_base_path):
            ...
            if not doc:
                ...
                docs = [d for d in os.listdir(doc_base_path) if os.path.isdir(os.path.join(doc_base_path, d))]
    ...
    click.echo(f"Doc '{doc}' installed for module '{module}' in '{app}' for site '{site}'.")
